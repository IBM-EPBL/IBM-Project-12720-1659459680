...
API_KEY = "0bR6uXCVLMUS2W9wPnDSjidigUUlNZ69i3FgPcnsmFbT"
...
def login():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/59fd92d7-3b7c-4f09-a6bb-5e1a97d749d3/predictions?version=2022-11-19',json=payload_scoring,
